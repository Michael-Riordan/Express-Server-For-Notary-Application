...
app.get('/api/places', async (req, res) => {
    ...
    try {
        ...
        const response = await axios.get(`https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${query}&components=country:US|administrative_area:AZ&key=${apiKey}`)
