...
app.get('/api/places', async (req, res) => {
    ...
    try {
        ...
        const response = await axios.get(`https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${query}&location=33.5387%-112.1860&radius=49000&strictbounds=true&components=country:US&key=${apiKey}`)
